...
export type StorageHash =
  StorageHashBase<'5bb63710b63518e0d5ccbbfcec09104b0a5b8a49e651a1a2d93b041ee67eac62'>;
export type ExecutionHash =
  ExecutionHashBase<'1b3ba66d5f19aedf9ec63da98ab21e4c8e7d8a006d30199b006155fca3eb3819'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly mission: CodecTypes['pg/text@1']['output'];
      readonly admin: CodecTypes['pg/bool@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly mission: CodecTypes['pg/text@1']['input'];
      readonly admin: CodecTypes['pg/bool@1']['input'];
...
export namespace Models {
  export type public_User = {
    ...
    mission: CodecTypes['pg/text@1']['output'];
    admin: CodecTypes['pg/bool@1']['output'];
          ...
          readonly table: {
            readonly orderItem: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'orderItem_userId_idx_a489d58a';
                  readonly prefix: 'orderItem_userId_idx';
            ...
            readonly user: {
              columns: {
                ...
                readonly mission: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'garçom'>;
                  };
                };
                readonly admin: {
                ...
                readonly login: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'bloqueado'>;
                  };
                };
              };
              primaryKey: { readonly columns: readonly ['id'] };
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly mission: { readonly column: 'mission' };
